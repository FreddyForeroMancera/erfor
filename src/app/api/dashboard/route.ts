...
export async function GET(request: Request) {
  try {
    ...
    const [
      ...
      prisma.environmentalFile.count({ where: { ...baseWhere, status: "PREPARATION" } }),
      prisma.environmentalFile.count({ where: { ...baseWhere, status: "EVALUATION" } }),
      prisma.environmentalFile.count({ where: { ...baseWhere, status: "APPROVED" } }),
      prisma.environmentalFile.count({ where: { ...baseWhere, status: "COMPLETED" } }),
      prisma.environmentalFile.count({ where: { ...baseWhere, status: "DRAFT" } }),
